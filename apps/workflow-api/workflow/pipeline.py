...
class SiteWorkflowPipeline:
    ...
    def process(self, job_id: str, raw_payload: dict[str, Any], batch: WorkflowBatchRequest) -> dict[str, Any]:
        ...
        pdf_payload_path = self._write_json(job_dir / "generated-pdf-payload.json", pdf_payload)
        ...
        if batch.workflow_mode == "pdf_and_site":
        ...
        return {
            ...
            "pdf_payload_path": str(pdf_payload_path),
